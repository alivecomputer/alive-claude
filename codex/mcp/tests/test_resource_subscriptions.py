...
class ObserverBackendTests(unittest.TestCase):
    def test_private_alpha_uses_portable_polling_observer(self) -> None:
        from alive_mcp.resources import subscriptions

        self.assertIs(subscriptions.Observer, PollingObserver)
